      ...
      <main>
        <div>
          ...
          <div className="absolute space-y-6 cursor-pointer text-white p-40 font-ocr-a-extended text-xl justify-center bg-[#171717] flex flex-col items-center h-screen w-[65.5%] right-0 ">
            ...
            <button
              type="button"
              className=" text-gray-900 bg-white hover:bg-gray-100 border border-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 font-medium rounded-lg text-sm p-4 text-center inline-flex items-center dark:focus:ring-gray-600 dark:bg-gray-800 dark:border-gray-700 dark:text-white dark:hover:bg-gray-700 me-2 mb-2"
            >
              <svg
                aria-hidden="true"
